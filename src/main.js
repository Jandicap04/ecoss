...
const skins = [
  ...
  { id: 'pixel-bandit', name: 'PIXEL BANDIT', price: 40, core: '#775044', edge: '#e2a476', role: 'BANDIDO PIXEL', character: 'pixel', pixelStyle: 3 },
  { id: 'pixel-rider', name: 'PIXEL RIDER', price: 50, core: '#b96f43', edge: '#e9c09d', role: 'NOMADA PIXEL', character: 'pixel', pixelStyle: 4 },
  { id: 'pixel-mask', name: 'PIXEL MASK', price: 60, core: '#d98813', edge: '#f7c94d', role: 'MASCARA PIXEL', character: 'pixel', pixelStyle: 5 },
  { id: 'pixel-shadow', name: 'PIXEL SHADOW', price: 70, core: '#24252f', edge: '#777889', role: 'SOMBRA PIXEL', character: 'pixel', pixelStyle: 6 },
  { id: 'pixel-guard', name: 'PIXEL GUARD', price: 80, core: '#46414a', edge: '#b6aeb0', role: 'GUARDIA PIXEL', character: 'pixel', pixelStyle: 7 },
  { id: 'pixel-soldier', name: 'PIXEL SOLDIER', price: 90, core: '#4d4b48', edge: '#b7b3a8', role: 'SOLDADO PIXEL', character: 'pixel', pixelStyle: 8 },
